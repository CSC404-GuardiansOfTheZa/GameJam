Shader "Unlit/Outline"
{
    Properties
    {
        _OutlineColor("OutlineColor", Color) = (0.1249411, 1, 0, 0)
    ...
    SubShader
    {
        ...
        VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
        {
            ...
            float _Property_052a5bdab524454993c12ee38c389cfc_Out_0 = _ScaleFactor;
            float3 _Multiply_6c8c15eff22547df91fd4ffde2fb4acb_Out_2;
            Unity_Multiply_float3_float3((_Property_052a5bdab524454993c12ee38c389cfc_Out_0.xxx), IN.ObjectSpacePosition, _Multiply_6c8c15eff22547df91fd4ffde2fb4acb_Out_2);
            description.Position = _Multiply_6c8c15eff22547df91fd4ffde2fb4acb_Out_2;
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float4 _Property_4d596e803e6e495eb054504095a6f2fe_Out_0 = _OutlineColor;
            surface.BaseColor = (_Property_4d596e803e6e495eb054504095a6f2fe_Out_0.xyz);
            surface.Alpha = 1;
            return surface;
        }
